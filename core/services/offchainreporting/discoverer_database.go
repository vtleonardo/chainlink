...
INSERT INTO offchainreporting_discoverer_database (local_peer_id, remote_peer_id, ann, created_at, updated_at)
...
SELECT remote_peer_id, ann FROM offchainreporting_discoverer_database WHERE remote_peer_id = ANY($1) AND local_peer_id = $2`, pq.Array(peerIDs), d.peerID)
	if err != nil {
